...
from src.models.nn.optical_flow.spynet import  SPyNet

<<<<<<< HEAD:mmvsr/models/_salutor/borisvsr_impl.py
from mmvsr.models._refiner.fgd_refiner import AnyOrderDeformableAlignment as refiner
...
=======
from src.models.nn.aligners.fgd_aligner import AnyOrderDeformableAlignment as Aligner
from src.models.nn.ts_backbones.conv_module import ResidualBlocksWithInputConv as Extractor
from src.models.nn.ts_propagators.feedforward import AnyOrderBidirectionalFullyConnectedPropagator as Propagator
from src.models.nn.ts_upsamplers.conv_module import BasicVSRUpsampler
from src.models.nn.s_preprocessor.conv_module import BasicVSRPlusPlusSpatial
>>>>>>> c6610254e8531bb6ef3ffe54fecd2367e9d1571f:src/models/nn/enhancers/borisvsr_impl.py
...
class BorisVSRImpl(BaseModule):
    ...
    def __init__(self, mid_channels=64, num_blocks=30, spynet_pretrained=None, max_residue_magnitude=10):
        ...
        self.refiner_args = dict(in_channels=6*mid_channels, out_channels=mid_channels, 
