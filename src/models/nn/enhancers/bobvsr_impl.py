...
<<<<<<< HEAD:mmvsr/models/_salutor/bobvsr_impl.py
...
from src.models.nn.ts_propagators.feedforward import FirstOrderBidirectionalSlidingWindowPropagator as Propagator
...
>>>>>>> c6610254e8531bb6ef3ffe54fecd2367e9d1571f:src/models/nn/enhancers/bobvsr_impl.py
...
class BobVSRImpl(BaseModule):
    ...
    def __init__(self, mid_channels=64, num_blocks=30, spynet_pretrained=None, max_residue_magnitude=10):
        ...
        self.refiner_args = dict(in_channels=2*mid_channels, out_channels=mid_channels, 
