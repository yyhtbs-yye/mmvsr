...
from src.registry import OPTIM_WRAPPER_CONSTRUCTORS
...
class SinGANOptimWrapperConstructor:
    ...
    :class:`~src.models.editors.singan.SinGANMultiScaleGenerator` and
    :class:`~src.models.editors.singan.SinGANMultiScaleDiscriminator`.
