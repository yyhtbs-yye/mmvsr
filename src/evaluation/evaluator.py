...
from src.registry import EVALUATORS
...
class Evaluator(Evaluator):
    ...
    Score (IS, :class:`~src.evaluation.InceptionScore`) only needs to
    take fake images as input. However, Frechet Inception Distance (FID,
    :class:`~src.evaluation.FrechetInceptionDistance`) needs to take
    ...
    :class:`~src.evaluation.PerceptualPathLength`), generator need
    ...
    :meth:`src.engine.runner.MultiValLoop.run` and
    :meth:`src.engine.runner.MultiTestLoop.run`.
